...
class GPattach():
    def __init__(self, obj):
        ...
        obj.setEditorMode("a3AttParentSubobjPlacement", ['NoRecompute', 'ReadOnly'])
        ...
        obj.addProperty("App::PropertyString", "b1AttChild", "Attachment",
             'The container Object where the attachment child pivot resides in - autogenerated')
        ...
        obj.setEditorMode("b3AttChildSubobjPlacement", ['NoRecompute', 'ReadOnly'])

        # calculation
        obj.addProperty("App::PropertyPlacement", "c2AttChildPlcInverse", "Attachment",
            'inverse of global Placement of Link Target SubObject - autogenerated - changes will be overwritten')
        obj.setEditorMode("c2AttChildPlcInverse", ['NoRecompute', 'ReadOnly'])
        ...
        obj.setEditorMode("c3AttChildResultPlc", ['NoRecompute', 'ReadOnly'])
    ...
    def execute(self, obj):
        ...
        if obj.LinkedObj:       #obj.b1AttChild:
            obj.b1AttChild = obj.LinkedObj.Name
            if hasattr(obj.LinkedObj, 'Group'):
                subobjs = [ itm.Name for itm in obj.LinkedObj.Group ]
                if hasattr(obj.LinkedObj, 'Origin'):
                    subobjs.append('Origin')
        ...
        if obj.LinkedObj and pathChild:
            pathChild += '.'
            plcChild = obj.LinkedObj.getSubObject(pathChild,3)
            if plcChild:
